...
print(f'\RandomForest Regression Model has been created\n')
...
st.sidebar.image('pngwing.com(8).png', caption = f'Welcome {username}')
...
if st.button('Press To Predict'):
    ...
    st.image('pngwing.com(3).png', width = 200)
